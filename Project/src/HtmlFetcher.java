...
public class HtmlFetcher {
	 ...
	 * @see #isRedirect(Map)
	 */
	public static String fetch(URL url, int redirects) throws Exception {
	 ...
	 * @see #fetch(URL, int)
	 */
	public static String fetch(String url, int redirects) throws MalformedURLException, Exception {
	 ...
	 * @throws Exception 
	 */
	public static String fetch(URL url) throws Exception {
		return fetch(url, 0);
	}
}
